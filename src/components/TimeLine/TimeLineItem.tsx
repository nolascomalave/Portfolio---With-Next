    ...
    return (
        <li className="group relative grid grid-cols-2 odd:-me-3 even:-ms-3">
            <div className="relative flex items-start gap-4 group-odd:flex-row-reverse group-odd:text-right group-even:order-last">
                <span className="size-3 shrink-0 rounded-full bg-dark-purple"></span>

                <div className="-mt-2">
                    <time className="text-xs/none font-medium text-dark-purple">{year}</time>
                    <h2 className="text-md font-bold text-neon-green">{company}</h2>
